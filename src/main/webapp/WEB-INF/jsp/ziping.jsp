...
<body>
	...
	<div class="container">
		<!-- Illustration -->
		<div style="<%=string%>">
		<h1 class="page-header">2020年研究生党员自我评议问卷</h1>
		<p>
			亲爱的同学：您好。研究生党员自评是每位党员对2019年11月至今自身表现的综合评议，用来促进同学们自我管理、自我教育、自我提醒、不断提升自身素质和能力。党员、预备党员必须填写，非党员同学无须填写。评议题目都为客观题，选项分为很好、较好、一般、较差和很差五项或者是、否两项。必须完成所有题目，方可提交。谢谢您的配合和支持！</p>
		...
		<div class="row">
			<div class="col-sm-8">
				<p>评议类别：党员自评</p>
				<h2 class="page-header"style="<%=unstring%>">(非党员无需进行）！请完成全部评议后点击提交</h2>
			</div>
		</div>
		<!--
			...
			<div class="panel panel-danger" style="<%=string%>">
				...
				<div class="panel-body">
					...
					<div class="radio" style="display: inherit">
						...
						<div class="col-sm-2">
							<!--  MODIFIED  -->
							<label> <input type="radio" name="ScoreQ1" value="1" checked="checked">
								很差
							</label>
						</div>
			...
			<div class="panel panel-danger" style="<%=string%>">
				...
				<div class="panel-body">
					...
					<div class="radio" style="display: inherit">
						...
						<div class="col-sm-2">
							<!--  MODIFIED  -->
							<label> <input type="radio" name="ScoreQ2" value="1" checked="checked">
								很差
							</label>
						</div>
			...
			<div class="panel panel-danger" style="<%=string%>">
				...
				<div class="panel-body">
					...
					<div class="radio" style="display: inherit">
						...
						<div class="col-sm-2">
							<!--  MODIFIED  -->
							<label> <input type="radio" name="ScoreQ3" value="1" checked="checked">
								很差
							</label>
						</div>
					</div>
			...
			<div class="panel panel-danger" style="<%=string%>">
				...
				<div class="panel-body">
					...
					<div class="radio" style="display: inherit">
						...
						<div class="col-sm-2">
							<!--  MODIFIED  -->
							<label> <input type="radio" name="ScoreQ4" value="1" checked="checked">
								很差
							</label>
						</div>
					</div>
			...
			<div class="panel panel-danger" style="<%=string%>">
				...
				<div class="panel-body">
					...
					<div class="radio" style="display: inherit">
						...
						<div class="col-sm-2">
							<!--  MODIFIED  -->
							<label> <input type="radio" name="ScoreQ5" value="1" checked="checked">
								很差
							</label>
						</div>
					</div>
			...
			<div class="panel panel-danger" style="<%=string%>">
				...
				<div class="panel-body">
					...
					<div class="radio" style="display: inherit">
						...
						<div class="col-sm-2">
							<!--  MODIFIED  -->
							<label> <input type="radio" name="ScoreQ6" value="1" checked="checked">
								很差
							</label>
						</div>
					</div>
