...
<div class="container">
	<!-- Illustration -->
	<h1 class="page-header">2020年研究生党员评议问卷</h1>
	<p>
		亲爱的同学：您好。研究生党员评议是对研究生党支部内每一位党员2019年11月至今表现所进行的评议，鼓励大家增进彼此了解、密切联系，互相取长补短。其中，每一位党员（含预备党员）必须评议所在党支部的所有其他党员，对应集体的非党员同学可以对所在集体的党员进行评议。评议题目为客观题。必须完成所有题目，方可提交。谢谢您的配合和支持！</p>
	<!-- Current information -->
	<div class="row">
		<div class="col-sm-4">
			<p>
	...
	<div class="panel panel-danger" style="<%=string%>">
		<form class="form-inline col-sm-12" role="form"
			...
			<button style="<%=string%>" id="btna" disabled="disabled" type="submit" class="btn btn-default">下一步</button>
		</form>
...
<script>
    $(document).ready(function(){
        $('input[type=checkbox]').click(function(){
            ...
            if($("input[class="+"best"+"]:checked").length > 0 && $("input[class="+"worst"+"]:checked").length > 0)
            {
            ...
            if (type != "contact") {
                ...
                var anotherName;
                if (type == "best")
                    anotherName = "worst_" + stuId;
                else if (type == "worst")
                    anotherName = "best_" + stuId;
